...
// This component is used to display the interactive exercises at the end of the lessons
  ...
  return (
    <Link href={href} className={cn('block group no-underline')}>
      <Card
        ...
        <CardHeader>
          <CardTitle
            className={cn('text-2xl font-bold', 'transition-colors duration-300 ease-in-out')}>
            Interactive Exercise
          </CardTitle>
        </CardHeader>
        <CardContent className={cn('transition-colors duration-300 ease-in-out')}>
          {children}
        </CardContent>
      </Card>
    </Link>
