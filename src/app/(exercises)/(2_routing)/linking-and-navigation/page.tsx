 ...
 * 4. Once you click the link, you should be redirected to the '/useRouter' page.
 * 5. Open the folder called useRouter in this directory to continue with the next part of the exercise.
 *
