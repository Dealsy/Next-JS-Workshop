...
<ThemeImage
  darkSrc="/images/dark_ssr.svg"
  lightSrc="/images/light_ssr.svg"
...
<ThemeImage
  darkSrc="/images/dark_ssr_stream.svg"
  lightSrc="/images/light_ssr_stream.svg"
  alt="SSR diagram showing how SSR works in Next.js"
  size="xxlarge"
/>
...
In the loading.tsx lesson, we talked about how the loading screens happen when data is loading, and behind the scenes the
...
, you could think of this as a prodile picture where the picutre itself is being fetched from an API or Database,
...
- Wrap a component in a Suspense boundary
