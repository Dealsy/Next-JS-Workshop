...
<ThemeImage
  darkSrc="/images/dark_parallel.svg"
  lightSrc="/images/light_parallel.svg"
...
<ThemeImage
  darkSrc="/images/dark_para_modal.svg"
  lightSrc="/images/light_para_modal.svg"
  alt="Parallel Routes diagram showing how parallel routes work in Next.js"
  size="large"
/>

We will learn more about this in the intercepting routes lesson.
...
<ThemeImage
  darkSrc="/images/dark_para_loading.svg"
  lightSrc="/images/light_para_loading.svg"
  alt="Parallel Routes diagram showing how parallel routes work in Next.js"
  size="xs"
/>
...
<InteractiveExercises href="/parallel-routes">
Ready to try it yourself? Head over to the Parallel Routes Exercise where you'll:

- Create a dashboard using multiple parallel routes
- Create fallback UI's
